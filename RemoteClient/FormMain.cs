...
namespace RemoteClient
{
    public partial class FormMain : Form
    {
        ...
        {
            // Adding PNG back in to the begining of the image
        ...
        private void ReadInfo(string Info)
        {
            ...
            if (Info.StartsWith("SCREEN_"))
            {
                ...
                Settings.LoadProfile(); // Load a profile for this screen on the server machine 
                SendScreenSize();
            }
        }
        ...
        {
            // Making a new screen-shot or clip-board text to come in from the server
            Bitmap Image = null;
